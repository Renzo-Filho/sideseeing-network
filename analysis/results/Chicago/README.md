...
**None is an accepted cross-city model matrix.** See the [current methods and continuation](../../../docs/chicago/CHICAGO_FUNCTIONAL_EXTENSION.md). SP releases remain separate and unchanged.
