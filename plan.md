...
Updated 11 September 2026. This is the current research scope. [Implementation methods](docs/archive/plans/SP_ATTRIBUTE_IMPLEMENTATION_PLAN.md) and the [current resolution handoff](docs/sp/SP_DATA_RESOLUTION_HANDOFF.md) govern detailed definitions, evidence and continuation.
